...
class ExtendedTextEditingController extends ValueNotifier<TextEditingValue> {
  /// Creates a controller for an editable text field.
  ///
  /// This constructor treats a null [text] argument as if it were the empty
  /// string.
  ExtendedTextEditingController({String text})
      : super(text == null
  ...
  /// [TextEditingValue.empty].
  ExtendedTextEditingController.fromValue(TextEditingValue value)
      : assert(
          value == null ||
...
class ExtendedEditableText extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<ExtendedTextEditingController>(
...
class ExtendedEditableTextState extends State<ExtendedEditableText>
  ...
  final ExtendedClipboardStatusNotifier _clipboardStatus =
      kIsWeb ? null : ExtendedClipboardStatusNotifier();
  ...
  bool showToolbar() {
    ...
    print(
        "_selectionOverlay.toolbarIsVisible:${_selectionOverlay == null ? null : _selectionOverlay.toolbarIsVisible}");
  ...
  // VoidCallback _semanticsOnCut(ExtendedTextSelectionControls controls) {
  //   return widget.selectionEnabled &&
  //           cutEnabled &&
  //           _hasFocus &&
  ...
  // VoidCallback _semanticsOnPaste(ExtendedTextSelectionControls controls) {
  //   return widget.selectionEnabled &&
  //           pasteEnabled &&
  //           _hasFocus &&
  ...
  Widget build(BuildContext context) {
    ...
    final ExtendedTextSelectionControls controls = widget.selectionControls;
    return MouseRegion(
...
class _ExtendedEditable extends LeafRenderObjectWidget {
  const _ExtendedEditable({
    Key key,
    this.textSpan,
    this.value,
