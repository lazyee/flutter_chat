...
class _ExtendedTextSpanEditingController extends ExtendedTextEditingController {
  _ExtendedTextSpanEditingController({@required TextSpan textSpan})
...
class _ExtendedSelectableTextSelectionGestureDetectorBuilder
    extends ExtendedTextSelectionGestureDetectorBuilder {
  _ExtendedSelectableTextSelectionGestureDetectorBuilder({
    @required _ExtendedSelectableTextState state,
  })  : _state = state,
        super(delegate: state);

  final _ExtendedSelectableTextState _state;
  ...
  void selectAllAndShowToolbar() {
    ...
    renderEditable.onSelectionChanged(
        textSelection, renderEditable, SelectionChangedCause.longPress);
...
class ExtendedSelectableText extends StatefulWidget {
  ...
  @override
  _ExtendedSelectableTextState createState() => _ExtendedSelectableTextState();
...
class _ExtendedSelectableTextState extends State<ExtendedSelectableText>
  ...
  _ExtendedTextSpanEditingController _controller;
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder =
        _ExtendedSelectableTextSelectionGestureDetectorBuilder(state: this);
    _controller = _ExtendedTextSpanEditingController(
  ...
  Widget build(BuildContext context) {
    ...
    ExtendedTextSelectionControls textSelectionControls;
