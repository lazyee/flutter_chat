...
class ExtendedTextSelectionOverlay {
    ...
    _handles = <OverlayEntry>[
      OverlayEntry(
          builder: (BuildContext context) =>
              _buildHandle(context, ExtendedTextSelectionHandlePosition.start)),
      OverlayEntry(
          builder: (BuildContext context) =>
              _buildHandle(context, ExtendedTextSelectionHandlePosition.end)),
    ];
  ...
  Widget _buildHandle(
      BuildContext context, ExtendedTextSelectionHandlePosition position) {
    if ((_selection.isCollapsed &&
            position == ExtendedTextSelectionHandlePosition.end) ||
        selectionControls == null)
      return Container(); // hide the second handle when collapsed
    return Visibility(
        visible: handlesVisible,
        child: _ExtendedTextSelectionHandleOverlay(
  ...
  void _handleSelectionHandleChanged(TextSelection newSelection,
      ExtendedTextSelectionHandlePosition position) {
    TextPosition textPosition;
    switch (position) {
      case ExtendedTextSelectionHandlePosition.start:
        textPosition = newSelection.base;
        break;
      case ExtendedTextSelectionHandlePosition.end:
...
class _ExtendedTextSelectionHandleOverlay extends StatefulWidget {
  const _ExtendedTextSelectionHandleOverlay({
    Key key,
  ...
  final ExtendedTextSelectionHandlePosition position;
  final LayerLink startHandleLayerLink;
  final LayerLink endHandleLayerLink;
  final RenderEditable renderObject;
  ...
  @override
  _ExtendedTextSelectionHandleOverlayState createState() =>
      _ExtendedTextSelectionHandleOverlayState();
...
class _ExtendedTextSelectionHandleOverlayState
    extends State<_ExtendedTextSelectionHandleOverlay>
  ...
  @override
  void didUpdateWidget(_ExtendedTextSelectionHandleOverlay oldWidget) {
